...
enum SupabaseConfiguration {
    ...
    static let courierProjectURL = URL(string: "https://yhrkthushductbplnxjq.supabase.co")!
...
public final class SupabaseManager: @unchecked Sendable {
    ...
    private init() {
        ...
        self.courierClient = SupabaseClient(
            supabaseURL: SupabaseConfiguration.courierProjectURL,
            supabaseKey: SupabaseConfiguration.courierSimulatorAnonKey
        )
    }
}
